...
var $countKick = document.getElementById('count-kick');
var $countSuperKick = document.getElementById('count-super-kick');
var character = {
  name: 'Pikachu',
  defaultHP: 100,
  damageHP: 100,
...
function countKick(count) {
  return function () {
    count--;
    $countKick.innerText = "\u0423 \u0432\u0430\u0441 \u043E\u0441\u0442\u0430\u043B\u043E\u0441\u044C ".concat(count, " \u043D\u0430\u0436\u0430\u0442\u0438\u0439");
...
function countSuperKick(count) {
  return function () {
    count--;
    $countSuperKick.innerText = "\u0423 \u0432\u0430\u0441 \u043E\u0441\u0442\u0430\u043B\u043E\u0441\u044C ".concat(count, " \u043D\u0430\u0436\u0430\u0442\u0438\u0439");
...
var kick = countKick(7);
var superKick = countSuperKick(1);
init();